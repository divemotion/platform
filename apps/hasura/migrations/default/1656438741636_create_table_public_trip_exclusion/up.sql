...
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER "set_public_trip_exclusion_updated_at"
BEFORE UPDATE ON "public"."trip_exclusion"
FOR EACH ROW
EXECUTE PROCEDURE "public"."set_current_timestamp_updated_at"();
COMMENT ON TRIGGER "set_public_trip_exclusion_updated_at" ON "public"."trip_exclusion" 
